...
@section('slide')
    <!-- Page Header Start -->
    <div class="container-fluid  mb-5" style="background-image: url('../img/bgu2.jpg'); background-size: cover; background-position: center;">
        <div class="d-flex flex-column align-items-center justify-content-center" style="min-height: 300px">
            <h1 class="font-weight-semi-bold text-uppercase mb-3" style="color: white; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Giỏ Hàng</h1>
            <div class="d-inline-flex">
                ...
                <p class="m-0" style="color: white; text-shadow: 2px 2px 4px rgba(0, 0, 0, 0.5);">Giỏ Hàng</p>
            </div>
        </div>
    </div>
    <!-- Page Header End -->
